<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="RomanYashin.aspx.cs" Inherits="RomanYashin" %>
...
.slider1 { background-image: url(img/Foto/Оксана.jpg); }
.slider2 { background-image: url(img/Foto/face.png); }
.slider3 { background-image: url(img/Foto/myphoto.jpg); }
.slider4 { background-image: url(img/Foto/Oksana.jpg); }
.slider5 { background-image: url(img/Foto/papa.jpg); }
.slider6 { background-image: url(img/Foto/сканирование0002.jpg); }
...
.slide2r1 { background-image: url(img/arts/тварь7.1.jpg); }
.slide2r2 { background-image: url(img/arts/nkio.jpg); }
.slide2r3 { background-image: url(img/arts/spaceShit.jpg); }
.slide2r4 { background-image: url(img/arts/StolastVSTvar.jpg); }
.slide2r5 { background-image: url(img/arts/ПлемБрокаПротивВетниковХаоса.jpg); }
.slide2r6 { background-image: url(img/arts/хвост.jpg); }
...
#slider6:checked ~ .slider > .slider6 {
	opacity: 1;
	z-index: 1;
...
#slide2r3:checked ~ .slider > .slide2r3,
#slide2r4:checked ~ .slider > .slide2r4,
#slide2r5:checked ~ .slider > .slide2r5,
#slide2r6:checked ~ .slider > .slide2r6 {
	opacity: 1;
	z-index: 1;
	-webkit-transform: scale(1);
	-moz-transform: scale(1);
...
#slider6:checked ~ .controls label:nth-of-type(6) {
	background: #ddd;
}
...
#slide2r3:checked ~ .controls label:nth-of-type(3),
#slide2r4:checked ~ .controls label:nth-of-type(4),
#slide2r5:checked ~ .controls label:nth-of-type(5),
#slide2r6:checked ~ .controls label:nth-of-type(6) {
	background: #ddd;
}
.wrapper label:hover, 
...
.wrapper label:after {
    ...
    <a name="Resume"><h1><asp:Label ID="TitleLable" runat="server" Text="Label"></asp:Label></h1></a><p><a href="img/РезюмеР.docx" download>резюме.docx</a></p><p><a href="img/РезюмеР.pdf" download>резюме.pdf</a></p>
    <div class="jumbotron">
        <table><tr><td style="width: 50%"><img alt="" style: width ="50%"  src="Images/Царь!.jpg" /></td> <td><p style="background: #eeeeee" class="lead"><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></p></td></tr></table>
...
<div class="content">
			...
			<ul id="sdt_menu" class="sdt_menu">
				<li>
					<a href="#BattleOfTribes">
						...
						<span class="sdt_wrap">
							...
							<span class="sdt_descr">поле для творчества</span>
						</span>
					</a>
                    <div class="sdt_box">
				...
				<li>
					<a href="#SuperProgressia">
						...
						<span class="sdt_wrap">
							...
							<span class="sdt_descr">быстро и интересно</span>
						</span>
					</a>
					<div class="sdt_box">
				...
				<li>
					<a href="#JasperCats">
						<img src="img/LOgoArts.jpg" alt=""/>
						<span class="sdt_active"></span>
						<span class="sdt_wrap">
							<span class="sdt_link">Арты/Фото</span>
							<span class="sdt_descr">Под вдохновением</span>
						</span>
					</a>
                    <div class="sdt_box">
							<a href="#Arts">Арты</a>
...
<p style="color: green">Первая моя игра, к которой я с другом приступил. Благодаря ей я полюбил программирование, Текстурирование, анимирование и многое другое. Из-за того что это большой проэкт, я полностью разобрался в Unity3d, 3ds max, ZBrush...</p>
</td></tr></table>
</div>
...
<div class="wrapper">
	...
	<div class="slider">
		<div class="slides slide1"><center><h3 style="color: white; background: #000;">Сделал текстуры для 15-ти 3d моделей и визуализировал их способности и заклинания</h3></center></div>
		<div class="slides slide2"><center><h3 style="color: white; background: #000;">Сделал текстуры для 15-ти зданий и анимировал их постройку</h3></center></div>
		<div class="slides slide3"><center><h3 style="color: white; background: #000;">Сделал игровой интерфейс и окружение в игре</h3></center></div>
		<div class="slides slide5"><center><h3 style="color: white; background: #000;">Полностью графически оформил систему достижений и статистики</h3></center></div>
	</div>
	<div class="controls">
...
<div class="wrapper1r">
	...
	<div class="slider">
		...
		<div class="slides slide1r2"><center><h3 style="color: white; background: #000;">Сделал различные фоны и эффекты для них, нарисовал достижения и эффекты их получения, создал музыку для игры</h3></center></div>
		<div class="slides slide1r3"><center><h3 style="color: white; background: #000;">Помага разработать четыре режима игры с использованием разных математических схем</h3></center></div>
		<div class="slides slide1r4"><center><h3 style="color: white; background: #000;">Оформил систему райтингов пользователей</h3></center></div>
	</div>
	<div class="controls">
    ...
    <br><br>
    <div>
        <br><br><br><a name="Arts">_</a><br><br><br><br><br><br>
           <table><tr><td>
                     <img style="width: 40%" src="img/LOgoArts.jpg" alt=""/>
           </td><td>
                     <h1><a name="Arts"> Арты </a></h1>
<p style="color: green">Данный сайт можно характеризовать как интернет-магазин котов, кошек и котят. Принялся за его разработку по заказу директора фирмы JasperCats.</p>
    ...
    <center><h2 style="color: green">Арты к играм</h2></center>
<div class="wrapper2r">
	<input type="radio" name="point2r" id="slide2r1" checked>
	<input type="radio" name="point2r" id="slide2r2">
    <input type="radio" name="point2r" id="slide2r3">
    <input type="radio" name="point2r" id="slide2r4">
    <input type="radio" name="point2r" id="slide2r5">
    <input type="radio" name="point2r" id="slide2r6">
	<div class="slider">
		<div class="slides slide2r1"></div>
		<div class="slides slide2r2"></div>
        <div class="slides slide2r3"></div>
        <div class="slides slide2r4"></div>
        <div class="slides slide2r5"></div>
        <div class="slides slide2r6"></div>
	</div>
	<div class="controls">
		<label for="slide2r1"></label>
		<label for="slide2r2"></label>
        <label for="slide2r3"></label>
        <label for="slide2r4"></label>
        <label for="slide2r5"></label>
        <label for="slide2r6"></label>

	</div>
</div>
    <br><br>
    <div>
        <br><br><br><a name="Foto">_</a><br><br><br><br><br><br>
           <table><tr><td>
                     <img style="width: 50%" src="img/Oks.jpg" alt=""/>
           </td><td>
                     <h1><a name="Foto"> Фото </a></h1>
<p style="color: green">Данная программа предназначена для помощи пользователям чья деятельность связана с загрузками грузовых автомобилей, при этом экономя их усилия и время. При разработке я научился работать с заказчиком, программировать разной сложности формулы и усовершенствовал свои навыки в Unity3D. </p>
    ...
    <center><h2 style="color: green">Обработка фотографий</h2></center>
<div class="wrapperr">
    ...
    <input type="radio" name="pointr" id="slider6">
	<div class="slider">
		<div class="slides slider1"></div>
		<div class="slides slider2"></div>
		<div class="slides slider3"></div>
		<div class="slides slider4"></div>
		<div class="slides slider5"></div>
        <div class="slides slider6"></div>
	</div>
	<div class="controls">
